We use the MATHS dataset of the article [Measuring Mathematical Problem Solving With the MATH Dataset](https://arxiv.org/pdf/2103.03874).
...
As a result, Gemini-pro-express-801 got 9 out of 10 questions right.
